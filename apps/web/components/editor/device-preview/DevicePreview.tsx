...
      >
        <button
          className="absolute -right-3.5 top-[90px] w-3 h-[60px] rounded-[3px] bg-[#333] border border-[#555] shadow-[inset_0_0_1px_rgba(255,255,255,0.2)] cursor-pointer active:translate-x-px"
...
                <div className="grid grid-cols-4 gap-5 p-5 rounded-[28px] bg-white/10 backdrop-blur-md">
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="w-14 h-14 rounded-2xl bg-white/30 shadow-lg" />
                  ))}
                </div>
              </div>
            </div>
